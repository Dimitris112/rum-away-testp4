...
class CaseInsensitiveUsernameBackendTest(TestCase):
    """Test case for the CaseInsensitiveUsernameBackend."""
    ...
    def test_authenticate_case_insensitive_username(self):
        ...
        for test_username in [
            ...
            self.assertEqual(
                user,
                self.user,
                f"Expected user to be authenticated for "
                f"username '{test_username}'"
            )

    def test_authenticate_incorrect_password(self):
        """Test authentication with the correct username but an
        incorrect password."""
        backend = CaseInsensitiveUsernameBackend()
        ...
        self.assertIsNone(
            user,
            "User should not be authenticated with an incorrect password."
        )
    ...
    def test_authenticate_nonexistent_user(self):
        ...
        self.assertIsNone(
            user,
            "User should not be authenticated due to a nonexistent username."
        )
    ...
    def test_authenticate_without_username(self):
        ...
        self.assertIsNone(
            user,
            "User should not be authenticated without a username."
        )
