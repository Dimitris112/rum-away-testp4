...
class Reservation(models.Model):
    ...
    def clean(self):
        """Validate that the number of guests does not exceed capacity
    ...
    def __str__(self):
        return (f"Reservation for {self.user.username} at "
                f"{self.reservation_time} in the {self.hall} area")
...
class UserProfile(models.Model):
    """Model representing a user profile, including a bio
    ...
    def get_profile_picture_url(self):
        """Return the profile picture URL or a default image
...
class Event(models.Model):
    """Model representing an event with a title, description,
    and schedule."""
    ...
    def get_next_occurrence(self):
        ...
        if self.recurrence == 'daily':
            ...
            return next_occurrence.replace(hour=20, minute=0,
                                           second=0, microsecond=0)
        return None
