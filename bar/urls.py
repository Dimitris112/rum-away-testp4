...
urlpatterns = [
    ...
    path('reservations/<int:reservation_id>/', views.reservations, name='reservations_with_id'),
    ...
    path('api/v1/users/<int:user_id>/profile/', user_profile_api, name='user_profile_api'),
